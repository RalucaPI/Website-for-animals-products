...
const Image = styled.div`
  ...
  border-radius: 1rem;
  background-image: url('https://img.freepik.com/premium-photo/cool-bird-wearing-sunglasses-against-pink-background_1187703-171758.jpg');
`;
...
export function BirdContainer({ height = 250, width = 400 }) {
...
///////////  
  const isRedirectedPage = location.pathname === "/birds";
  return (
    <>
